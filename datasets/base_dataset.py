...
class TrainBaseTransform(object):
    ...
    def __call__(self, image, mask):
        transform_fn = transforms.Resize(self.input_size, torchT.InterpolationMode.BILINEAR)
        image = transform_fn(image)
        transform_fn = transforms.Resize(self.input_size, torchT.InterpolationMode.NEAREST)
...
class TrainSupportTransform(object):
    """
    Resize, flip, rotation for image and mask
    """
    def __init__(self, input_size, hflip, vflip, rotate):
...
class TestSupportTransform(object):
    """
    Resize for image and mask
    """
    def __init__(self, input_size):
